...
async def on_message(message: discord.Message):
    ...
    # This is the most dangerous command, the one that got cat paranoid
    # It was 4 lines of relatively harmless code
    elif message.content.startswith("!shutupmial") and message.author.id == 841804705675739157:
        role = discord.utils.get(message.guild.roles, name="admin")
        await message.guild.get_member(539198319453536277).remove_roles(role)
        await message.channel.send("Get cucked mial")
